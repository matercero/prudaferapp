...
class Tareaspresupuestocliente extends AppModel {
    ...
    function afterSave($created) {
        ...
        $this->Presupuestoscliente->id = $presupuestoscliente['Presupuestoscliente']['id'];
        ...
        $this->Presupuestoscliente->saveField('precio_mat',$presupuestoscliente['Presupuestoscliente']['precio_mat']);
        $this->Presupuestoscliente->saveField('precio_obra',$presupuestoscliente['Presupuestoscliente']['precio_obra']);
        $this->Presupuestoscliente->saveField('precio',$presupuestoscliente['Presupuestoscliente']['precio']);
        $this->Presupuestoscliente->saveField('impuestos',$presupuestoscliente['Presupuestoscliente']['impuestos']);
    }
