...
class Ordene extends AppModel {
    ...
    var $belongsTo = array(
        ...
        'Mensajesordene' => array(
            'className' => 'Mensajesordene',
    ...
    function beforeSave($options) {
        if (empty($this->data['Ordene']['id']) && empty($this->data['Ordene']['numero'])) {
            $query = 'SELECT MAX(o.numero)+1 as siguiente  FROM ordenes o WHERE DATE_FORMAT(o.fecha,"%Y") = "' . date('Y') . '"';
