...
class TareasAlbaranesclientesreparacione extends AppModel {
    ...
    var $virtualFields = array(
        'total_partes_real' => 'TareasAlbaranesclientesreparacione.totalkilometrajereal + TareasAlbaranesclientesreparacione.totaldesplazamientoreal + TareasAlbaranesclientesreparacione.total_horastrabajoprecio_real + TareasAlbaranesclientesreparacione.totaldietasreales + TareasAlbaranesclientesreparacione.totalotroserviciosreales',
    ...
    function crear_desde_tarea_de_orden($tarea_id, $albaranesclientesreparacione_id) {
        ...
        foreach ($tarea['ArticulosTarea'] as $articulos_tarea) {
            ...
            $tareareparacion_articulo['ArticulosTareasAlbaranesclientesreparacione']['numero_tarea'];
            ...
            $tareareparacion_articulo['ArticulosTareasAlbaranesclientesreparacione']['precio_unidad'] = $articulos_tarea['precio_unidad'];
    ...
    function crear_desde_tarea_de_presupuesto($tarea_id, $albaranesclientesreparacione_id) {
        $tarea = $this->Albaranesclientesreparacione->Ordene->Presupuestoscliente->Tareaspresupuestocliente->find('first', array('contain' => array('Materiale' => 'Articulo'), 'conditions' => array('Tareaspresupuestocliente.id' => $tarea_id)));
        $tarea_albaranesclientesreparacione['TareasAlbaranesclientesreparacione']['albaranesclientesreparacione_id'] = $albaranesclientesreparacione_id;
        $tarea_albaranesclientesreparacione['TareasAlbaranesclientesreparacione']['tipo'] = $tarea['Tareaspresupuestocliente']['tipo'];
	$tarea_albaranesclientesreparacione['TareasAlbaranesclientesreparacione']['descripcion'] = $tarea['Tareaspresupuestocliente']['asunto'];
	$tarea_albaranesclientesreparacione['TareasAlbaranesclientesreparacione']['totaldesplazamientoreal'] = 0;
	$tarea_albaranesclientesreparacione['TareasAlbaranesclientesreparacione']['totaldesplazamientoimputado'] = 0;
	$tarea_albaranesclientesreparacione['TareasAlbaranesclientesreparacione']['totalkilometrajereal'] = 0;
	$tarea_albaranesclientesreparacione['TareasAlbaranesclientesreparacione']['totalkilometrajeimputable'] = 0;
	$tarea_albaranesclientesreparacione['TareasAlbaranesclientesreparacione']['totalpreciodesplazamiento'] = 0;
	$tarea_albaranesclientesreparacione['TareasAlbaranesclientesreparacione']['total_horastrabajoprecio_real']  = $tarea['Tareaspresupuestocliente']['mano_de_obra'];
	$tarea_albaranesclientesreparacione['TareasAlbaranesclientesreparacione']['total_horastrabajoprecio_imputable'] = $tarea['Tareaspresupuestocliente']['mano_de_obra'];
	$tarea_albaranesclientesreparacione['TareasAlbaranesclientesreparacione']['totaldietasreales'] = 0;
	$tarea_albaranesclientesreparacione['TareasAlbaranesclientesreparacione']['totaldietasimputables'] = 0;
	$tarea_albaranesclientesreparacione['TareasAlbaranesclientesreparacione']['totalotroserviciosreales'] = $tarea['Tareaspresupuestocliente']['servicios'] ;
	$tarea_albaranesclientesreparacione['TareasAlbaranesclientesreparacione']['totalotroserviciosimputables'] = $tarea['Tareaspresupuestocliente']['servicios'];
	$tarea_albaranesclientesreparacione['TareasAlbaranesclientesreparacione']['total_materiales_imputables'] = $tarea['Tareaspresupuestocliente']['materiales'];
	$tarea_albaranesclientesreparacione['TareasAlbaranesclientesreparacione']['total_materiales_costo'] = 0;
	$tarea_albaranesclientesreparacione['TareasAlbaranesclientesreparacione']['tarea_id'] = null;
	$tarea_albaranesclientesreparacione['TareasAlbaranesclientesreparacione']['total_manoobra_presupuestada'] = $tarea['Tareaspresupuestocliente']['mano_de_obra'];
	$tarea_albaranesclientesreparacione['TareasAlbaranesclientesreparacione']['total_materiales_presupuestado'] = $tarea['Tareaspresupuestocliente']['materiales'];
	$tarea_albaranesclientesreparacione['TareasAlbaranesclientesreparacione']['total_dietas_presupuestada'] = 0;	 	 	 	 	 	
	$tarea_albaranesclientesreparacione['TareasAlbaranesclientesreparacione']['total_varios_presupuestado'] = 0;	 	 	 	 	
	$tarea_albaranesclientesreparacione['TareasAlbaranesclientesreparacione']['total_desplazamiento_presupuestado'] = 0;
        $this->create();
        $this->save($tarea_albaranesclientesreparacione,array('callbacks' => false));
        /* Conversión de ArticulosTarea a ArticulosTareasAlbaranesclientesreparacione */
        $tareareparacion_articulo = array();
        foreach ($tarea['Materiale'] as $articulos_tarea) {
            $tareareparacion_articulo['ArticulosTareasAlbaranesclientesreparacione']['numero_tarea'] = '';
            $tareareparacion_articulo['ArticulosTareasAlbaranesclientesreparacione']['tareas_albaranesclientesreparacione_id'] = $this->id;
            $tareareparacion_articulo['ArticulosTareasAlbaranesclientesreparacione']['articulos_tarea_id'] = null;
            $tareareparacion_articulo['ArticulosTareasAlbaranesclientesreparacione']['precio_unidad'] = $articulos_tarea['precio_unidad'];
            $tareareparacion_articulo['ArticulosTareasAlbaranesclientesreparacione']['cantidadreal'] = $articulos_tarea['cantidad'];
            $tareareparacion_articulo['ArticulosTareasAlbaranesclientesreparacione']['cantidad'] = $articulos_tarea['cantidad'];
            $tareareparacion_articulo['ArticulosTareasAlbaranesclientesreparacione']['cantidad_presupuestada'] = $articulos_tarea['cantidad'];
            $tareareparacion_articulo['ArticulosTareasAlbaranesclientesreparacione']['descuento'] = $articulos_tarea['descuento'];
            $tareareparacion_articulo['ArticulosTareasAlbaranesclientesreparacione']['articulo_id'] = $articulos_tarea['Articulo']['id'];
            $tareareparacion_articulo['ArticulosTareasAlbaranesclientesreparacione']['presupuestado'] = $articulos_tarea['importe'];
            $this->ArticulosTareasAlbaranesclientesreparacione->create();
            $this->ArticulosTareasAlbaranesclientesreparacione->save($tareareparacion_articulo,array('callbacks' => false));
        }
        $this->Albaranesclientesreparacione->recalcularTotales($albaranesclientesreparacione_id);
    }

    public function recalcularTotales($deleted_id = null) {
        $config = ClassRegistry::init("Config")->findById(1);
        $tarea = $this->find('first', array('contain' => array('ArticulosTareasAlbaranesclientesreparacione' => 'Articulo', 'TareasAlbaranesclientesreparacionesParte', 'TareasAlbaranesclientesreparacionesPartestallere', 'Albaranesclientesreparacione' => array('Centrostrabajo', 'Cliente', 'Ordene' => array('Avisostallere', 'Centrostrabajo'))), 'conditions' => array('TareasAlbaranesclientesreparacione.id' => $this->id)));
        ...
        if ($tarea['TareasAlbaranesclientesreparacione']['tipo'] == 'centro') {
            foreach ($tarea['TareasAlbaranesclientesreparacionesParte'] as $partecentro) {
                if ($partecentro['id'] != $deleted_id) {
                    ...
                    $tarea['TareasAlbaranesclientesreparacione']['totaldesplazamientoimputado'] += ($partecentro['horasdesplazamientoimputables_ida'] * $tarea['Albaranesclientesreparacione']['Centrostrabajo']['preciohoradesplazamiento']) + ($partecentro['horasdesplazamientoimputables_vuelta'] * $tarea['Albaranesclientesreparacione']['Centrostrabajo']['preciohoradesplazamiento']);
                    ...
                    $tarea['TareasAlbaranesclientesreparacione']['totalkilometrajeimputable'] += ($partecentro['kilometrajeimputable_ida'] + $partecentro['kilometrajeimputable_vuelta'] ) * $tarea['Albaranesclientesreparacione']['Centrostrabajo']['preciokm'];
                    ...
                    $tarea['TareasAlbaranesclientesreparacione']['total_horastrabajoprecio_imputable'] += ($partecentro['horasimputables'] * $partecentro['preciohoraencentro']) * (1 - $partecentro['descuento_manodeobra'] / 100);
            ...
            foreach ($tarea['TareasAlbaranesclientesreparacionesPartestallere'] as $partetaller) {
                if ($partetaller['id'] != $deleted_id) {
                    ...
                    $tarea['TareasAlbaranesclientesreparacione']['total_horastrabajoprecio_imputable'] += ($partetaller['horasimputables'] * $partetaller['preciohoraentraller']) * (1 - $partetaller['descuento_manodeobra'] / 100);
    ...
    function dime_siguiente_numero($albaranesclientesreparacione_id) {
        $query = 'SELECT MAX(t.numero)+1 as siguiente  FROM tareas_albaranesclientesreparaciones t WHERE t.albaranesclientesreparacione_id = "' . $albaranesclientesreparacione_id . '"';
        $resultado = $this->query($query);
        if (!empty($resultado[0][0]['siguiente']))
            $res = $resultado[0][0]['siguiente'];
        else
            $res = 1;
        return $res;
    }
