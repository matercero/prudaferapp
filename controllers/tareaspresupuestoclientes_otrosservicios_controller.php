...
class TareaspresupuestoclientesOtrosserviciosController extends AppController {
    ...
    function edit($id = null) {
        ...
        $tarea_id = $this->data['TareaspresupuestoclientesOtrosservicio']['tareaspresupuestocliente_id'];
        $tarea = $this->TareaspresupuestoclientesOtrosservicio->Tareaspresupuestocliente->find('first', array('contain' => array('Presupuestoscliente' => array('Centrostrabajo', 'Cliente')), 'conditions' => array('Tareaspresupuestocliente.id' => $this->data['TareaspresupuestoclientesOtrosservicio']['tareaspresupuestocliente_id'])));
        if (!empty($tarea['Presupuestoscliente']['centrostrabajo_id'])) {
            $this->set('centrostrabajo', $tarea['Presupuestoscliente']['Centrostrabajo']);
        }
        $tareaspresupuestoclientes = $this->TareaspresupuestoclientesOtrosservicio->Tareaspresupuestocliente->find('list');
        $this->set(compact('tareaspresupuestoclientes','tarea_id'));
    }
