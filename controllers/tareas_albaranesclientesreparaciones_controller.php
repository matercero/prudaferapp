...
class TareasAlbaranesclientesreparacionesController extends AppController {
    ...
    function add($albaranesclientesreparacione_id = null ) {
        ...
        $numero = $this->TareasAlbaranesclientesreparacione->dime_siguiente_numero($albaranesclientesreparacione_id);
        
        $this->set(compact('albaranesclientesreparacione_id','numero'));
    }
