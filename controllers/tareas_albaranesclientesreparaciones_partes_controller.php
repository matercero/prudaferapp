...
class TareasAlbaranesclientesreparacionesPartesController extends AppController {
    ...
    function add($tareas_albaranesclientesreparacione_id = null) {
        if (!empty($this->data)) {
            if (!empty($this->data['TareasAlbaranesclientesreparacionesParte']['fecha']))
                $this->data['TareasAlbaranesclientesreparacionesParte']['fecha'] = date("Y-m-d H:i:s", strtotime($this->data['TareasAlbaranesclientesreparacionesParte']['fecha']));
