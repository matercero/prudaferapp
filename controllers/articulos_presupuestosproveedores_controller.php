    ...
    function add($presupuestosproveedore_id = null) {
        if (!empty($this->data)) {
            ...
            if ($this->ArticulosPresupuestosproveedore->save($this->data)) {
                $this->ArticulosPresupuestosproveedore->Presupuestosproveedore->id = $this->data['ArticulosPresupuestosproveedore']['presupuestosproveedore_id'];
                $this->ArticulosPresupuestosproveedore->Presupuestosproveedore->saveField('estadospresupuestosproveedore_id',2);
