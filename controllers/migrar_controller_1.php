...
class MigrarController extends AppController {
    ...
    function formapagos() {
        ...
        echo "<pre>INSERT INTO formapagos (nombre, tipodepago, numero_vencimientos, cliente_id) SELECT 'Contado', 'contado', 1, id FROM clientes </pre>";
        echo "<pre>INSERT INTO formapagos (nombre, tipodepago, numero_vencimientos,dias_entre_vencimiento, proveedore_id) SELECT 'transferencia', 'transferencia', 1,30, id FROM proveedores </pre>";
        die('Migracion de Forma de Pagos');
    }
    ...
    function cuentasbancarias() {
        ...
        if (($handle = fopen($path, "r")) !== FALSE) {
            while (($data = fgetcsv($handle, 1000, ";",'"')) !== FALSE) {
                if (!$primera_fila) {
                    ...
                    $cliente = $this->Cuentasbancaria->Cliente->find('first', array('contain' => array(), 'conditions' => array('Cliente.codcli' => $data[0])));
                    $cuentasbancaria['Cuentasbancaria']['cliente_id'] = $cliente['Cliente']['id'];
        ...
        die('Migracion de Cuentas Bancarias Finalizada');
    }
    ...
    function maquinas() {
        ...
        die('Migracion de Máquinas Finalizada');
    }
    ...
    function mecanicos() {
        ...
        die('Migracion de Mecanicos Finalizada');
    }
    ...
    function comerciales_proveedores() {
        ...
        die('Migracion de Comerciales Proveedores Finalizada');
    }
    ...
    function ordenes() {
        ...
        die('Migracion de Ordenes ( base )  Finalizada');
    }
    ...
    function tareas() {
        ...
        die('Migracion de Tareas  Finalizada');
    }
    ...
    function articulos_tareas() {
        ...
        die('Migracion de Articulos de Tareas  Finalizada');
    }
        ...
        if (($handle = fopen($path, "r")) !== FALSE) {
            while (($data = fgetcsv($handle, 1000, ";",'"')) !== FALSE) {
                if (!$primera_fila) {
                    ...
                    $albaranesclientesreparacione['Albaranescliente']['serie'] = $data[1];
                    $albaranesclientesreparacione['Albaranescliente']['numero'] = intval($data[2]);
                    $albaranesclientesreparacione['Albaranescliente']['fecha'] = str_fecha_mysql($data[0]);
                    $albaranesclientesreparacione['Albaranescliente']['observaciones'] = $data[17];
                    $albaranesclientesreparacione['Albaranescliente']['albaranescaneado'] = '';
                    $albaranesclientesreparacione['Albaranescliente']['facturable'] = 1;
                    ...
                    if ($fecha_del_albaran < $fecha_de_cambio_de_iva)
                        $albaranesclientesreparacione['Albaranescliente']['tiposiva_id'] = 11;
                    else
                        $albaranesclientesreparacione['Albaranescliente']['tiposiva_id'] = 1;
                    ...
                    $albaranesclientesreparacione['Albaranescliente']['ordene_id'] = $ordene['Ordene']['id'];
                    $albaranesclientesreparacione['Albaranescliente']['cliente_id'] = $ordene['Ordene']['cliente_id'];
                    $albaranesclientesreparacione['Albaranescliente']['centrostrabajo_id'] = $ordene['Ordene']['centrostrabajo_id'];
                    $albaranesclientesreparacione['Albaranescliente']['maquina_id'] = $ordene['Ordene']['maquina_id'];
                    ...
                    $albaranesclientesreparacione['Albaranescliente']['almacene_id'] = $almacene['Almacene']['id'];
                    $albaranesclientesreparacione['Albaranescliente']['facturas_cliente_id'] = null; // Al añadir las facturas hay que actualizar
                    $albaranesclientesreparacione['Albaranescliente']['es_devolucion'] = 0;
                    $albaranesclientesreparacione['Albaranescliente']['numero_aceptacion_aportado'] = '';
                    $albaranesclientesreparacione['Albaranescliente']['comerciale_id'] = null;
                    $albaranesclientesreparacione['Albaranescliente']['centrosdecoste_id'] = null;
                    $albaranesclientesreparacione['Albaranescliente']['estadosalbaranesclientesreparacione_id'] = 3;
        ...
        if (($handle = fopen($path, "r")) !== FALSE) {
            while (($data = fgetcsv($handle, 1000, ";",'"')) !== FALSE) {
                if (!$primera_fila && $data[0] == 'A') {
                    ...
                    if (!empty($albaranesclientesreparacione['Albaranescliente']['id'])) {
                        $this->Albaranesclientesreparacione->id = $albaranesclientesreparacione['Albaranescliente']['id'];
        ...
        if (($handle = fopen($path, "r")) !== FALSE) {
            while (($data = fgetcsv($handle, 1000, ";",'"')) !== FALSE) {
                if (!$primera_fila) {
                    ...
                    /* if (empty($albaranesclientesreparacione['Albaranescliente']['id']))
                      pr($conditions); */
                    $tarea['TareasAlbaranesclientesreparacione']['albaranesclientesreparacione_id'] = $albaranesclientesreparacione['Albaranescliente']['id'];
                    $tarea['TareasAlbaranesclientesreparacione']['descripcion'] = $data[4];
                    $tarea_orden = $this->TareasAlbaranesclientesreparacione->Tarea->find('first', array('contain' => array(), 'conditions' => array('Tarea.numero' => $data[0], 'Tarea.ordene_id' => $albaranesclientesreparacione['Albaranescliente']['ordene_id'])));
    ...
    function articulos_tareas_albaranesclientesreparaciones() {
         ...
         */
        $articulos_bad = 0;
        $path = '../csvs/ALFAMAT-REPARACION.csv';
        $primera_fila = true;
        if (($handle = fopen($path, "r")) !== FALSE) {
            while (($data = fgetcsv($handle, 1000, ";",'"')) !== FALSE) {
                if (!$primera_fila) {
                    ...
                    $tarea = $this->ArticulosTareasAlbaranesclientesreparacione->TareasAlbaranesclientesreparacione->find('first', array('contain' => array(), 'fields' => array('id'), 'conditions' => array('TareasAlbaranesclientesreparacione.numero' => intval($data[0]), 'TareasAlbaranesclientesreparacione.albaranesclientesreparacione_id' => $albaranesclientesreparacione['Albaranescliente']['id'])));
            ...
            while (($data = fgetcsv($handle, 1000, ";",'"')) !== FALSE) {
                if (!$primera_fila) {
                    if (intval($data[0]) >= 800 && intval($data[0]) < 900) {
                        ...
                        $tarea = $this->TareasAlbaranesclientesreparacionesParte->TareasAlbaranesclientesreparacione->find('first', array('contain' => array(), 'fields' => array('id'), 'conditions' => array('TareasAlbaranesclientesreparacione.numero' => intval($data[1]), 'TareasAlbaranesclientesreparacione.albaranesclientesreparacione_id' => $albaranesclientesreparacione['Albaranescliente']['id'])));
                ...
                if (!$primera_fila) {
                    ...
                    if (!empty($data[19]) && !empty($data[30])) {
                        ...
                        if (empty($facturas_cliente)) {
                            ...
                            $FacturasCliente['FacturasCliente']['serie'] = $data[19];
                            $FacturasCliente['FacturasCliente']['numero'] = intval($data[30]);
        ...
        if (($handle = fopen($path, "r")) !== FALSE) {
            while (($data = fgetcsv($handle, 1000, ";",'"')) !== FALSE) {
                if (!$primera_fila) {
                    ...
                    $ArticulosPedidosproveedore['ArticulosPedidosproveedore']['cantidad'] = doubleval(str_replace(',', '.', $data[6]));
    ...
    function migrar_auto() {
        ...
        $data[0] = '0';
        $this->loadModel('Cliente');
        $clientes = $this->Cliente->find('first', array('contain' => array(), 'conditions' => array('Cliente.codcli' => $data[0])));
        pr($clientes);
