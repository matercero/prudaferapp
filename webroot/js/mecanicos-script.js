$(function() {
    $( ".autocomplete" ).autocomplete({
        source: proyect_url()+"mecanicos/auto_complete",
        minLength: 3,
    ...
    $('.add_articulo_img').click(function(){
        var html = '<div><img src="'+proyect_url()+'img/delete.png" class="delete_articulo_img" alt=""><input type="text" class="autocomplete" value="Inserte el nombre del mecánico"/><input type="hidden" name="data[Mecanico][Mecanico][]" class="mecanico_id" value=""/></div>';
