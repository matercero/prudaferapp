<?php
//echo '<pre>';
// echo var_dump($albaranes);
//echo '</pre>';
$cabecera = array('FECHA', 'SERIE', 'numero', 'Orden_numero','Observaciones','Nº_factura','Cliente','Centrostrabajo','Máquina', 'horas_maquina','Avisostallere');
$line = $cabecera;
