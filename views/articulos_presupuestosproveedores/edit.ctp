...
<script type="text/javascript">
    ...
    function calcular(element){
        ...
        /*Calculo del Neto*/
        $('#ArticulosPresupuestosproveedoreNeto').val(redondear2decimales(precio_proveedor-(precio_proveedor*descuento/100))); 
        neto =  $('#ArticulosPresupuestosproveedoreNeto').val(); 
        /*Calculo del total*/
        $('#ArticulosPresupuestosproveedoreTotal').val(redondear2decimales(parseFloat(neto)*parseFloat(cantidad)));
    }
