<div class="seriespedidoscompras">
    ...
    <fieldset>
        <legend>
            ...
            <?php echo $this->Html->link(__('Borrar', true), array('action' => 'delete', $this->Form->value('Seriespedidoscompra.id')), array('class' => 'button_link'), sprintf(__('¿Seguro que quieres borrar la serie # %s?', true), $this->Form->value('Seriespedidoscompra.serie'))); ?>
