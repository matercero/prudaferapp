<div class="seriespedidoscompras">
    <h2>
        <?php __('Series de Pedidos de Compra'); ?>
    ...
    <table cellpadding="0" cellspacing="0">
        ...
        <?php
        $i = 0;
        foreach ($seriespedidoscompras as $seriespedidoscompra):
            $class = null;
            if ($i++ % 2 == 0) {
                $class = ' class="altrow"';
            }
            ?>
            <tr<?php echo $class; ?>>
                <td><?php echo $seriespedidoscompra['Seriespedidoscompra']['serie']; ?>&nbsp;</td>
                <td class="actions">
                    <?php echo $this->Html->link(__('Ver', true), array('action' => 'view', $seriespedidoscompra['Seriespedidoscompra']['id'])); ?>
                    <?php echo $this->Html->link(__('Editar', true), array('action' => 'edit', $seriespedidoscompra['Seriespedidoscompra']['id'])); ?>
                </td>
            </tr>
        <?php endforeach; ?>
    </table>
