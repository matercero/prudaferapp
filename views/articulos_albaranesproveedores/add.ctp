...
<fieldset>
    ...
    <?php
    if (!empty($albaranesproveedore['Albaranesproveedore']['almacene_id']))
        echo $this->Autocomplete->replace_select('Articulo', null, true, $albaranesproveedore['Albaranesproveedore']['almacene_id']);
    else
