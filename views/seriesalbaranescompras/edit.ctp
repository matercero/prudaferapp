<div class="seriesalbaranescompras">
    ...
    <fieldset>
        <legend>
            ...
            <?php echo $this->Html->link(__('Borrar', true), array('action' => 'delete', $this->Form->value('Seriesalbaranescompra.id')), array('class' => 'button_link'), sprintf(__('¿Seguro que quieres borrar la serie # %s?', true), $this->Form->value('Seriesalbaranescompra.serie'))); ?>
