<div class="seriesalbaranescompras">
    <h2>
        <?php __('Series de Albaranes de Compra'); ?>
    ...
    <table cellpadding="0" cellspacing="0">
        ...
        <?php
        $i = 0;
        foreach ($seriesalbaranescompras as $seriesalbaranescompra):
            $class = null;
            if ($i++ % 2 == 0) {
                $class = ' class="altrow"';
            }
            ?>
            <tr<?php echo $class; ?>>
                <td><?php echo $seriesalbaranescompra['Seriesalbaranescompra']['serie']; ?>&nbsp;</td>
                <td class="actions">
                    <?php echo $this->Html->link(__('Ver', true), array('action' => 'view', $seriesalbaranescompra['Seriesalbaranescompra']['id'])); ?>
                    <?php echo $this->Html->link(__('Editar', true), array('action' => 'edit', $seriesalbaranescompra['Seriesalbaranescompra']['id'])); ?>
                </td>
            </tr>
        <?php endforeach; ?>
    </table>
