    ...
    <table class="view edit">
        <tr>
            ...
            <?php if (isset($centrostrabajo) && $centrostrabajo['modofacturacion'] == 'preciofijio'): ?>
                <td><p class="success">El Centro de Trabajo factura por Precio fijo de Desplazamiento</p><?php echo $this->Form->input('desplazamiento', array('label' => false, 'readonly' => false, 'default' => $centrostrabajo['preciofijodesplazamiento'])); ?></td>
        ...
        <tr>
            ...
            <?php elseif (isset($centrostrabajo) && $centrostrabajo['modofacturacion'] == 'preciofijio'): ?>
                <td>Precio Hora <input type="text" id="precio_hora_desplazamiento"  value="0"/></td>
        ...
        <tr>
            ...
            <?php elseif (isset($centrostrabajo) && $centrostrabajo['modofacturacion'] == 'preciofijio'): ?>
                <td>Precio Km <input type="text" id="precio_km_desplazamiento"  value="0" /></td>
