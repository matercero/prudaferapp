        ...
        <table class="view">
            ...
            <tr>
                ...
                <td>
                    ...
                    <p>
                        ...
                        <?php echo $this->Form->input('horas_maquina', array('default' => 0, 'value' => $avisotallere['Avisostallere']['horas_maquina'])); ?>
                    </p>
                </td>
                <td>
                    <p>
            ...
            <tr>
                <td colspan="1">
                    ...
                    <?php echo $this->Form->input('mantenimientos', array('label' => false, 'value' => $avisotallere['Avisostallere']['aviso_mantenimiento'])); ?>
                </td>
                <td colspan="2">
            ...
            <tr>
                <td colspan="4">
                    <?php echo $this->Form->input('file', array('type' => 'file', 'label' => 'Orden Escaneada')); ?>
                </td>
            </tr>
        </table>
    </fieldset>
