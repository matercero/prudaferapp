<div class="avisostalleres">
    ...
    <table class="view">
        <tr>
            <td>
                <span>Fecha:</span>
                <?php echo $this->Time->format('d-m-Y H:i:s',$avisostallere['Avisostallere']['fechaaviso']); ?>
            </td>
            <td>
                <span>Estado:</span>
            ...
            <td>
                ...
                <?php echo $this->Time->format('d-m-Y',$avisostallere['Avisostallere']['fechaaceptacion'] );?>
            </td>
        </tr>
        <tr>
            <td>
        ...
        <tr>
            <td>
                <span>Riesgos</span>  
                <?php echo $avisostallere['Cliente']['riesgos'] == 0 ? '' : '<span style="color: red">RIESGO SUPERADO</span>' ?>
            </td>
            <td>
                <span>Aviso:</span>
        ...
        <tr>
			<td>
                <span>Mantenimiento, horas:</span><span style="color: green"> 
                <?php echo $avisostallere['Avisostallere']['aviso_mantenimiento']; ?> 
			</td>
            <td colspan="3">
