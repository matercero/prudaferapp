<div class="seriesfacturascompras">
    <h2>
        <?php __('Series de Facturas de Compra'); ?>
    ...
    <table cellpadding="0" cellspacing="0">
        ...
        <?php
        $i = 0;
        foreach ($seriesfacturascompras as $seriesfacturascompra):
            $class = null;
            if ($i++ % 2 == 0) {
                $class = ' class="altrow"';
            }
            ?>
            <tr<?php echo $class; ?>>
                <td><?php echo $seriesfacturascompra['Seriesfacturascompra']['serie']; ?>&nbsp;</td>
                <td class="actions">
                    <?php echo $this->Html->link(__('Ver', true), array('action' => 'view', $seriesfacturascompra['Seriesfacturascompra']['id'])); ?>
                    <?php echo $this->Html->link(__('Editar', true), array('action' => 'edit', $seriesfacturascompra['Seriesfacturascompra']['id'])); ?>
                </td>
            </tr>
        <?php endforeach; ?>
    </table>
