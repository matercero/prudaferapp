<div class="presupuestosclientes">
    ...
    <table class="view">
        <tr>
            ...
            <td><?php echo!empty($presupuestoscliente['Presupuestoscliente']['fecha']) ? $this->Time->format('d-m-Y', $presupuestoscliente['Presupuestoscliente']['fecha']) : ''; ?></td>
        ...
        <tr>
            ...
            <td><?php echo!empty($presupuestoscliente['Presupuestoscliente']['fecha_enviado']) ? $this->Time->format('d-m-Y', $presupuestoscliente['Presupuestoscliente']['fecha_enviado']) : ''; ?></td>
        ...
        <tr>
            <td><span><?php __('Presupuesto Escaneado'); ?></span></td>
            <td  colspan="9"><?php echo $this->Html->link(__($presupuestoscliente['Presupuestoscliente']['presupuestoescaneado'], true), '/files/presupuestoscliente/' . $presupuestoscliente['Presupuestoscliente']['presupuestoescaneado']); ?></td>
        </tr>
    </table>
    <div class="related">
                    ...
                    <td colspan="5">
                            ...
                            <table>
                                ...
                                <?php foreach ($tarea['Manodeobra'] as $manodeobra): ?>
                                    <tr>
                                        ...
                                        <td class="actions">
                                            <?php echo $this->Html->link('Editar', array('controller' => 'manodeobras', 'action' => 'edit', $manodeobra['id']),array( 'class' => ' button_link popup')) ?>
                                            <?php echo $this->Html->link('Eliminar', array('controller' => 'manodeobras', 'action' => 'delete', $manodeobra['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $manodeobra['id'])) ?>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </table>
                            ...
                            <table>
                                ...
                                <?php if (!empty($tarea['TareaspresupuestoclientesOtrosservicio'])): ?>
                                    <tr>
                                        ...
                                        <td class="actions">
                                            <?php echo $this->Html->link('Editar', array('controller' => 'tareaspresupuestoclientes_otrosservicios', 'action' => 'edit', $tarea['TareaspresupuestoclientesOtrosservicio']['id']),array('class'=>'popup')) ?>
                                            <?php echo $this->Html->link('Eliminar', array('controller' => 'tareaspresupuestoclientes_otrosservicios', 'action' => 'delete', $tarea['TareaspresupuestoclientesOtrosservicio']['id']), null, sprintf(__('Seguro que quieres eliminar los otros conceptos?', true), $tarea['TareaspresupuestoclientesOtrosservicio']['id'])) ?>
                                        </td>
                                    </tr>
                                <?php endif; ?>
                            </table>
                        ...
                        <table class="tabla_materiales_tarea" id="tareaid-<?php echo $tarea['id'] ?>">
                            <tr class="tr_titulos">
                                ...
                                <th>Articulo</th>
                                <th>Stock</th>
                                <th>Precio Costo <br/>* Último Precio Compra</th>
                                <th>Cantidad</th>
                                <th>Precio Ud.</th>
                                <th>Descuento</th>
                                <th>Importe</th>
                            ...
                            <?php if (!empty($tarea['Materiale'])): ?>
                                <?php foreach ($tarea['Materiale'] as $materiale): ?>
                                    <tr id="materialeid-<?php echo $materiale['id'] ?>">
                                        ...
                                        <td><?php echo redondear_dos_decimal($materiale['Articulo']['existencias']) ?></td>
                                        ...
                                        <td class="actions">
                                            <?php echo $this->Html->link('Editar', array('controller' => 'materiales', 'action' => 'edit', $materiale['id']), array('class' => 'popup')) ?>
                                            <?php echo $this->Html->link('Eliminar', array('controller' => 'materiales', 'action' => 'delete', $materiale['id']), null, sprintf(__('Seguro que quieres borrar el material?', true), $materiale['id'])) ?>
                                            <?php echo $this->Html->link('Ver Ultima Venta', array('controller' => 'materiales', 'action' => 'ver_ultima_venta', $materiale['id']), array('class' => 'button_link popup')) ?>
                                        </td>
                                    </tr>
        ...
        <div style="margin:20px;">
            ...
            <?php echo $this->Html->link(__('Imprimir', true), array('action' => 'pdf', $presupuestoscliente['Presupuestoscliente']['id']), array('class' => 'button_link')); ?>
            <?php echo $this->Html->link(__('Factura proforma', true), array('action' => 'pdf_facturapro', $presupuestoscliente['Presupuestoscliente']['id']), array('class' => 'button_link')); ?>
        </div>
        <div class="datagrid">
            <table>
                ...
                <tbody>
                    ...
                    if (!empty($presupuestoscliente['Avisostallere']['id'])):
                        ...
                        <tr <?php echo $class ?>>
                            ...
                            <td><?php echo $this->Html->link('Ver', array('controller' => 'avisostalleres', 'action' => 'view', $presupuestoscliente['Avisostallere']['id']), array('class' => 'button_brownie')) ?></td>
                        </tr>
                    <?php endif; ?>
                    <?php
    ...
    $(function() {
        $( ".tabla_materiales_tarea" ).sortable({
            ...
            receive: function(event, ui) {
                ...
                $.post('<?php echo Configure::read('proyect_url') ?>materiales/update_tarea/',{'data': {'tareaspresupuestocliente_id': tareaspresupuestocliente_id, 'materiale_id': materiale_id}});
