        ...
        <table class="view">
            ...
            <?php if (!empty($maquina['Articulosparamantenimiento'])): ?>
                ...
                <?php foreach ($maquina['Articulosparamantenimiento'] as $articulosparamantenimiento): ?>
                    <tr>
                        <td><?php echo $this->Html->link(__($articulosparamantenimiento['Articulo']['ref'], true), array('controller' => 'articulos', 'action' => 'view', $articulosparamantenimiento['Articulo']['id'])); ?></td>
                        ...
                        <td><?php echo $articulosparamantenimiento['precio_sin_iva'] ?></td>
						<td><?php echo $articulosparamantenimiento['C_Horas'] ?></td>
                        <td class="actions">
                            <?php echo $this->Html->link(__('Editar', true), array('controller' => 'articulosparamantenimientos', 'action' => 'edit', $articulosparamantenimiento['id']), array('class' => 'button_link popup')); ?>
                            <?php echo $this->Html->link(__('Borrar', true), array('controller' => 'articulosparamantenimientos', 'action' => 'delete', $articulosparamantenimiento['id']), array('class' => 'button_link'), sprintf(__('Are you sure you want to delete # %s?', true), $articulosparamantenimiento['Articulo']['ref'])); ?>
                        </td>
        ...
        <table class="view">
            ...
            <?php if (!empty($maquina['Otrosrepuesto'])): ?>
                ...
                <?php foreach ($maquina['Otrosrepuesto'] as $otrosrepuesto): ?>
                    <tr>
                        <td><?php echo $this->Html->link(__($otrosrepuesto['Articulo']['ref'], true), array('controller' => 'articulos', 'action' => 'view', $otrosrepuesto['Articulo']['id'])); ?></td>
                        ...
                        <td><?php echo $otrosrepuesto['Articulosparamantenimiento']['precio_sin_iva'] ?></td>
