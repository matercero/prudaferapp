...
<table class="edit"">
    <tr>
        ...
        <td><?php echo $this->Form->input('codigo', array('label' => false,'style'=>'width: 95px;')); ?></td>
    ...
    <tr>
        ...
        <td><?php echo $this->Form->input('nombre', array('label' => false,'style'=>'width: 95px;')); ?></td>
    ...
    <tr>
        ...
        <td><?php echo $this->Form->input('serie_maquina', array('label' => false,'style'=>'width: 95px;')); ?></td>
    ...
    <tr>
        ...
        <td><?php echo $this->Form->input('modelo_transmision', array('label' => false,'style'=>'width: 95px;')); ?></td>
    ...
    <tr>
        ...
        <td><?php echo $this->Form->input('horas', array('label' => false,'style'=>'width: 95px;')); ?></td>
        <td colspan="4">
