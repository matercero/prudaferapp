<div class="albaranesproveedores">
    ...
    <table class="view">
        <tr>
            <td>
                <span>Serie</span>
                <?php echo $albaranesproveedore['Albaranesproveedore']['serie']; ?>
            </td>
            <td>
                <span>Número</span>
            ...
            <td>
                ...
                <?php echo $albaranesproveedore['Tiposiva']['tipoiva']; ?> --- <?php echo $albaranesproveedore['Tiposiva']['porcentaje_aplicable']; ?>
            </td>
            <td>
                <span>Estado</span>
        ...
        <tr>
            <td>
                <span>Proveedor</span>
                <?php echo $albaranesproveedore['Proveedore']['nombre']; ?>
            </td>
            <td>
                <span>Fecha</span>
                <?php echo !empty($albaranesproveedore['Albaranesproveedore']['fecha']) ? $this->Time->format('d-m-Y',$albaranesproveedore['Albaranesproveedore']['fecha']) : ''; ?>
            </td>
            <td>
        ...
        <tr>
            <td colspan="3">
                ...
                <?php echo $this->Html->link(__($albaranesproveedore['Albaranesproveedore']['albaranescaneado'], true), '/files/albaranesproveedore/' . $albaranesproveedore['Albaranesproveedore']['albaranescaneado']); ?>
            </td>
            <td>
            ...
            <table cellpadding = "0" cellspacing = "0">
                ...
                if (!empty($articulos_albaranesproveedore)) {
                    ...
                    foreach ($articulos_albaranesproveedore as $articulo_albaranesproveedore):
                        ...
                        ?>
                        <tr<?php echo $class; ?>>
							<td><?php echo $this->Html->link(__($articulo_albaranesproveedore['Articulo']['ref'], true), array('controller' => 'articulos', 'action' => 'view', $articulo_albaranesproveedore['Articulo']['ref'])); ?></td>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <?php echo redondear_dos_decimal($total * ($albaranesproveedore['Tiposiva']['porcentaje_aplicable'] / 100)) ?> &euro;
                    </td>
                </tr>
                <tr>
                    <td colspan="7"></td>
                    <td style="text-align: center">
                        ...
                        <?php echo redondear_dos_decimal($total + ($total * ($albaranesproveedore['Tiposiva']['porcentaje_aplicable'] / 100))) ?> &euro;
                    </td>
                </tr>
            </table>
        <?php endif; ?>
    ...
    <div style="margin: 20px;">
        <?php if (isset($presupuestosproveedore)): ?>
