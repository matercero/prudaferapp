<div class="seriespedidosventas">
    <h2>
        <?php __('Series de Pedidos de Venta'); ?>
    ...
    <table cellpadding="0" cellspacing="0">
        ...
        <?php
        $i = 0;
        foreach ($seriespedidosventas as $seriespedidosventa):
            $class = null;
            if ($i++ % 2 == 0) {
                $class = ' class="altrow"';
            }
            ?>
            <tr<?php echo $class; ?>>
                <td><?php echo $seriespedidosventa['Seriespedidosventa']['serie']; ?>&nbsp;</td>
                <td class="actions">
                    <?php echo $this->Html->link(__('Ver', true), array('action' => 'view', $seriespedidosventa['Seriespedidosventa']['id'])); ?>
                    <?php echo $this->Html->link(__('Editar', true), array('action' => 'edit', $seriespedidosventa['Seriespedidosventa']['id'])); ?>
                </td>
            </tr>
        <?php endforeach; ?>
    </table>
