<div class="pedidosproveedores">
    ...
    <table class="view">
        <tr>
            <td>
                <span>Serie</span>
                <?php echo $pedidosproveedore['Pedidosproveedore']['serie']; ?>
            </td>
            <td>
                <span>Número</span>
            ...
            <td>
                ...
                <?php echo $pedidosproveedore['Tiposiva']['tipoiva']; ?> - <?php echo $pedidosproveedore['Tiposiva']['porcentaje_aplicable']; ?> 
            </td>
            <td>
                <span>Referencia Proveedor</span>
                <?php echo $pedidosproveedore['Pedidosproveedore']['referencia_proveedor'] ?>
            </td>
        </tr>
        <tr>
            <td>
                <span>Proveedor</span>
                <?php echo $pedidosproveedore['Proveedore']['nombre']; ?>
            </td>
            <td>
                <span>Fecha</span>
                <?php echo!empty($pedidosproveedore['Pedidosproveedore']['fecha']) ? $this->Time->format('d-m-Y', $pedidosproveedore['Pedidosproveedore']['fecha']) : ''; ?>
            </td>
            <td>
                <span>Almacen de los Materiales</span>
                <?php echo $pedidosproveedore['Almacene']['nombre']; ?>
            </td>
            <td>
        ...
        <tr>
            ...
            <td>
                ...
                <?php !empty($pedidosproveedore['Pedidosproveedore']['fecharecepcion']) ? $this->Time->format('d-m-Y', $pedidosproveedore['Pedidosproveedore']['fecharecepcion']) : '' ?>
            </td>
        </tr>
        <tr>
            <td>
        ...
        <?php if (!empty($pedidosproveedore['ArticulosPedidosproveedore'])): ?>
            ...
            <table cellpadding = "0" cellspacing = "0">
                ...
                foreach ($pedidosproveedore['ArticulosPedidosproveedore'] as $articulo_pedidoproveedore):
                    ...
                    ?>
                    <tr<?php echo $class; ?>>
						<td><?php echo $this->Html->link(__($articulo_pedidoproveedore['Articulo']['ref'], true), array('controller' => 'articulos', 'action' => 'view', $articulo_pedidoproveedore['Articulo']['id'])); ?></td>
                        ...
                        <td><?php echo $articulo_pedidoproveedore['pendiente_servir']; ?></td>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <?php echo redondear_dos_decimal($total * ($pedidosproveedore['Tiposiva']['porcentaje_aplicable'] / 100)) ?> &euro;
                    </td>
                </tr>
                <tr>
                    <td colspan="7"></td>
                    <td style="text-align: center">
                        ...
                        <?php echo redondear_dos_decimal($total + ($total * ($pedidosproveedore['Tiposiva']['porcentaje_aplicable'] / 100))) ?> &euro;
                    </td>
                </tr>
            </table>
        <?php endif; ?>
    ...
    <div style="margin: 20px">
        ...
        <?php echo $this->Html->link(__('Imprimir', true), array('action' => 'pdf', $pedidosproveedore['Pedidosproveedore']['id']), array('class' => 'button_link')); ?>
    </div>
    <div class="datagrid related" style="margin-top: 30px">
        <table>
            ...
            <tbody>
                ...
                <?php endif; ?>
                <?php
                if (!empty($pedidosproveedore['Presupuestosproveedore']['id'])):
                    $class = null;
                    $i++;
                    if ($i % 2 == 0)
                        $class = ' class="alt"';
                    ...
                    <tr <?php echo $class ?>>
                        ...
                        <td><?php echo $pedidosproveedore['Presupuestosproveedore']['numero'] ?></td>
                        <td><?php echo!empty($pedidosproveedore['Presupuestosproveedore']['fecha']) ? $this->Time->format('d-m-Y', $pedidosproveedore['Presupuestosproveedore']['fecha']) : '' ?></td>
                        <td><?php echo $pedidosproveedore['Presupuestosproveedore']['Proveedore']['nombre'] ?></td>
                        <td><?php echo $this->Html->link('Ver', array('controller' => 'presupuestosproveedores', 'action' => 'view', $pedidosproveedore['Presupuestosproveedore']['id']), array('class' => 'button_brownie')) ?></td>
                    </tr>
                <?php endif; ?>
                <?php
                if (!empty($pedidosproveedore['Presupuestosproveedore']['Presupuestoscliente'])):
