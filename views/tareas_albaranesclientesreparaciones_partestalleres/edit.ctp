        ...
        <tr>
            <td>
                ...
                <table>
                    ...
                    <tr>
                        <td><?php echo $this->Form->input('preciohoraentraller', array('label' => false, 'readonly' => false, 'default'=>0)); ?></td>
                    </tr>
                    <tr>
...
<script type="text/javascript">
    $(function(){
        date = new Date('<?php echo $this->Form->value('TareasAlbaranesclientesreparacionesPartestallere.fecha') ?>');
        
        // Horas de Trabajo
        $('#TareasAlbaranesclientesreparacionesPartestallereHorainicio').timeEntry({show24Hours: true});
        $('#TareasAlbaranesclientesreparacionesPartestallereHorafinal').timeEntry({show24Hours: true});
        ...
        $('#TareasAlbaranesclientesreparacionesPartestallereFecha').dateEntry('setDate', date);
    })
</script>