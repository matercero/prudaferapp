<div class="seriespresupuestosventas">
    <h2>
        <?php __('Series de Presupuestos de Venta'); ?>
    ...
    <table cellpadding="0" cellspacing="0">
        ...
        <?php
        $i = 0;
        foreach ($seriespresupuestosventas as $seriespresupuestosventa):
            $class = null;
            if ($i++ % 2 == 0) {
                $class = ' class="altrow"';
            }
            ?>
            <tr<?php echo $class; ?>>
                <td><?php echo $seriespresupuestosventa['Seriespresupuestosventa']['serie']; ?>&nbsp;</td>
                <td class="actions">
                    <?php echo $this->Html->link(__('Ver', true), array('action' => 'view', $seriespresupuestosventa['Seriespresupuestosventa']['id'])); ?>
                    <?php echo $this->Html->link(__('Editar', true), array('action' => 'edit', $seriespresupuestosventa['Seriespresupuestosventa']['id'])); ?>
                </td>
            </tr>
        <?php endforeach; ?>
    </table>
