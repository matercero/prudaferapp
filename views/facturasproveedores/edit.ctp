    ...
    <fieldset>
        ...
        <table class="view">
            ...
            <tr>
                ...
                <td>
                    <?php echo $this->Form->input('fechafactura', array('label' => 'Fecha','dateFormat'=>'DMY')); ?>
                </td>
                <td>
                    <?php echo $this->Form->input('fechapagada', array('label' => 'Fecha de pago','empty' => '--','dateFormat'=>'DMY')); ?>
                </td>
                <td>
                    <?php echo $this->Form->input('fechalimitepago', array('label' => 'Feche Límite de pago','empty' => '--','dateFormat'=>'DMY')); ?>
                </td>
            </tr>
            <tr>
                <td colspan="2">
            ...
            <tr>
                ...
                <td>
                    <?php echo $this->Form->input('numero_factura_aportado', array('label' => 'Número de Factura Aportado')); ?>
                </td>
            </tr>
            <tr>
                <td colspan="4">
