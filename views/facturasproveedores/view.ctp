<div class="facturasproveedores">
    ...
    <table class="view">
        <tr>
            ...
            <td>
                <span>Serie</span>
                <?php echo $facturasproveedore['Facturasproveedore']['serie']; ?>
            </td>
            <td>
                <span>Número</span>
        ...
        <tr>
            ...
            <td>
                <span>Fecha</span>
                <?php echo !empty($facturasproveedore['Facturasproveedore']['fechafactura'])&& $facturasproveedore['Facturasproveedore']['fechafactura'] != '0000-00-00' ? $this->Time->format('d-m-Y', $facturasproveedore['Facturasproveedore']['fechafactura']) : ''; ?>
            </td>
            <td>
                <span>Fecha Pagada</span>
                <?php echo !empty($facturasproveedore['Facturasproveedore']['fechapagada'])&& $facturasproveedore['Facturasproveedore']['fechapagada'] != '0000-00-00' ? $this->Time->format('d-m-Y', $facturasproveedore['Facturasproveedore']['fechapagada']) : ''; ?>
            </td>
            <td>
                <span>Fecha Límite de Pago</span>
                <?php echo !empty($facturasproveedore['Facturasproveedore']['fechalimitepago'])&& $facturasproveedore['Facturasproveedore']['fechalimitepago'] != '0000-00-00' ? $this->Time->format('d-m-Y', $facturasproveedore['Facturasproveedore']['fechalimitepago']) : ''; ?>
            </td>
        </tr>
        <tr>
            <td colspan="2">
        ...
        <tr>
            ...
            <td>
                <span>Número Factura Aportado</span>
                <?php echo @$facturasproveedore['Facturasproveedore']['numero_factura_aportado']?>
            </td>
            <td>
        ...
        <table cellpadding="0" cellspacing="0">
            ...
            foreach ($facturasproveedore['Albaranesproveedore'] as $albaranesproveedore):
                ...
                <tr<?php echo $class; ?>>
                    ...
                    <td><?php echo $albaranesproveedore['Centrosdecoste']['codigo']; ?> - <?php echo $albaranesproveedore['Centrosdecoste']['denominacion']; ?></td>
