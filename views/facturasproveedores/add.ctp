<div class="facturasproveedores form">
    ...
    <fieldset>
        <legend><?php __('Añadir Factura de proveedor desde el Albarán ' . $albaranesproveedore['Albaranesproveedore']); ?></legend>
        <?php
        echo $this->Form->input('fechafactura', array('label' => 'Fecha','dateFormat'=>'DMY'));
        ...
        echo $this->Form->input('fechalimitepago', array('label' => 'Feche Límite de pago','dateFormat'=>'DMY'));
        echo $this->Form->input('fechapagada', array('label' => 'Fecha de pago','dateFormat'=>'DMY'));
