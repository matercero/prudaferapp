...
foreach ($facturasCliente['Albaranescliente'] as $albaranescliente) {
    ...
    <tr>
        ...
        <tr>
            <td colspan="2"><b>CENTRO TRABAJO: </b>' . isset($albaranescliente['Centrostrabajo']['centrotrabajo']) . '</td>
            <td><b>COMERCIAL: </b>' . isset($albaranescliente['Comerciale']['nombre']) . ' ' . isset($albaranescliente['Comerciale']['apellidos']) . '</td>
            <td><b>MAQUINA: </b>' . isset($albaranescliente['Maquina']['nombre']) . '</td>
        </tr>
        <tr> 
...
$html .= '
  ...
  <tr>
  <th style="text-align:  centre; font-size: 7pt;">LOS TRABAJOS, REPUESTOS Y ACCESORIOS ESTÁN SUJETOS A LAS GARANTIAS ESTABLECIDAS LEGALMENTE</th>
  </tr>
  </table>
  <table style="font-size: 0.7em;">
...
$pdf->Output(WWW_ROOT . 'factura1.pdf', 'FD');
?>
