    ...
    <table class="view">
        ...
        <tr>
            ...
            <td style="font-size: 100%;">
                <?php echo $facturasCliente['FacturasCliente']['pago'] == 0 ? 'PENDIENTE' : '<span style="color: green">PAGADA</span>'; ?></td>
        </tr>
        <tr>
        ...
        <table cellpadding="0" cellspacing="0">
            ...
            foreach ($facturasCliente['Albaranescliente'] as $albaranescliente):
                ...
                <tr<?php echo $class; ?>>
                    ...
                    <td><?php echo @$albaranescliente['Centrosdecoste']['codigo']; ?> - <?php echo @$albaranescliente['Centrosdecoste']['denominacion']; ?></td>
        ...
        <table cellpadding="0" cellspacing="0">
            ...
            foreach ($facturasCliente['Albaranesclientesreparacione'] as $albaranesclientesreparacione):
                ...
                <tr<?php echo $class; ?>>
                    ...
                    <td><?php echo $albaranesclientesreparacione['Centrosdecoste']['codigo']; ?> - <?php echo $albaranesclientesreparacione['Centrosdecoste']['denominacion']; ?></td>
