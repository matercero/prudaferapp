    ...
    <fieldset>
        ...
        <table class="edit">
            <tr>
                ...
                <td><?php echo $this->Form->input('serie', array('type' => 'select', 'options' => $series, 'value' => $config['Seriespedidosventa']['serie'], 'label' => false)); ?></td>
            ...
            <tr>
                ...
                <td><?php echo $this->Form->input('tiposiva_id', array('label' => false,'empty' =>'-- Seleccionar IVA --','selected' =>$presupuestoscliente['Presupuestoscliente']['tiposiva_id'])); ?></td>
                <td colspan="2"></td>
            ...
            <tr>
                ...
                <td><?php echo $this->Form->input('fecha_plazo', array('label' => false, 'dateFormat' => 'DMY')); ?></td>
            </tr>
        </table>
        <div class="related">
