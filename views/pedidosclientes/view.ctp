<div class="pedidosclientes">
    ...
    <table class="view">
        <tr>
            ...
            <td><?php echo!empty($pedidoscliente['Pedidoscliente']['fecha']) ? $this->Time->format('d-m-Y', $pedidoscliente['Pedidoscliente']['fecha']) : ''; ?></td>
        ...
        <tr>
            ...
            <td><?php echo $pedidoscliente['Tiposiva']['tipoiva']; ?></td>
            <td colspan="2"></td>
        ...
        <tr>
            ...
            <td><?php echo !empty($pedidoscliente['Pedidoscliente']['fecha_plazo']) ? $this->Time->format('d-m-Y', $pedidoscliente['Pedidoscliente']['fecha_plazo']) : ''; ?></td>
        </tr>
    </table>
    <div class="related">
