...
<div class="presupuestosproveedores">
    ...
    <fieldset>
        <legend>
            <?php __('Presupuesto de Proveedor Directo ( De Almacen ) Serie ' . $this->Form->value('Presupuestosproveedore.serie') . ' Nº ' . $this->Form->value('Presupuestosproveedore.numero')); ?>
        ...
        <table class="view">
            <tr>
                <td><?php echo $this->Form->input('serie', array('type' => 'select', 'options' => $series)) ?></td>
            ...
            <tr>
                <td  colspan="2">
                    ...
                    <?php echo $this->Form->input('agenciadetransporte'); ?>
                </td>
                <td>
                    <span>Portes</span>
                    <?php echo $this->Form->input('portes',array('options'=>array('Debidos'=>'Debidos','Pagados'=>'Pagados'),'empty'=>'')); ?>
                </td>
            </tr>
        </table>
        <div class="related">
