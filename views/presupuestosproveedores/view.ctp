...
<div class="presupuestosproveedores">
    ...
    <table class="view">
        <tr>
            <td>
                <span>Serie</span>
                <?php echo $presupuestosproveedore['Presupuestosproveedore']['serie']; ?>
            </td>
            <td>
                <span>Número</span>
        ...
        <tr>
            <td  colspan="2">
                ...
                <?php echo $presupuestosproveedore['Presupuestosproveedore']['agenciadetransporte']; ?>
            </td>
            <td>
                <span>Portes</span>
                <?php echo $presupuestosproveedore['Presupuestosproveedore']['portes']; ?>
            </td>
        </tr>
    </table>
        ...
        <table cellpadding = "0" cellspacing = "0">
            ...
            <tr>
                ...
                <td>
                    ...
                    <?php echo $total * ($presupuestosproveedore['Tiposiva']['porcentaje_aplicable'] / 100) ?> &euro;
                </td>
            </tr>
            <tr>
                <td colspan="8"></td>
                <td>
                    ...
                    <?php echo $total + ($total * ($presupuestosproveedore['Tiposiva']['porcentaje_aplicable'] / 100)) ?> &euro;
                </td>
            </tr>
        </table>
    <?php endif; ?>
    ...
    <div style="margin-bottom: 40px; text-align: center;">
        ...
        <?php echo $this->Html->link(__('Imprimir', true), array('action' => 'pdf', $presupuestosproveedore['Presupuestosproveedore']['id']), array('class' => 'button_link')); ?>
    </div>
    <div class="datagrid">
        <table>
