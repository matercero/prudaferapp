...
<script type="text/javascript">
    $('#vermaquina').change(function(){
        window.open('<?php echo Configure::read('proyect_url') ?>maquinas/view/'+$(this).val())  ;
    }); 
    $(function(){
        $('#vermaquina_chzn_o_0').click(function(){
            window.open('<?php echo Configure::read('proyect_url') ?>maquinas/view/'+$('#vermaquina').val())  ;
        });  
    })
