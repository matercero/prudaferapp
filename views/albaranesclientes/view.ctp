<div class="albaranesclientes">
    ...
    <table class="view">
        ...
        <tr>
            ...
            <td>
                <?php echo $this->Html->link($albaranescliente['Maquina']['nombre'], array('controller' => 'maquinas', 'action' => 'view', $albaranescliente['Maquina']['id'])); ?>
            </td>
            <td><span><?php __('Pedido de cliente'); ?></span></td>
            <td>
                <?php echo $this->Html->link($albaranescliente['Pedidoscliente']['numero'], array('controller' => 'pedidosclientes', 'action' => 'view', $albaranescliente['Pedidoscliente']['id'])); ?>              
            </td>
        </tr>
        <tr>
            <?php if (!empty($albaranescliente['Albaranescliente']['avisosrepuesto_id'])): ?>
                ...
                <td><span><?php __('Nº Serie Máquina'); ?></span>
        ...
        <tr>
            ...
            <td style="font-size: 120%;">
                <?php echo $albaranescliente['Cliente']['riesgos'] == 0 ? '<span style="color:green">RIESGO NO SUPERADO</span>' : '<span class="parpadea textoRiesgo">RIESGO SUPERADO</span>'; ?>
            </td>
        ...
        <tr>
            ...
            <td><?php echo $albaranescliente['Albaranescliente']['numero_aceptacion_aportado'] ?></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><?php echo $albaranescliente['Albaranescliente']['agenciadetransporte'] ?></td>
            <td><span><?php __('Portes') ?></span></td>
            <td><?php echo $albaranescliente['Albaranescliente']['portes'] ?></td>
            <td><span><?php __('Bultos'); ?></span></td>
            <td><?php echo $albaranescliente['Albaranescliente']['bultos'] ?></td>
        </tr>
    </table>
    <div class="related">
